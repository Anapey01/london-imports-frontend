...
const CSP = [
  ...
  `img-src 'self' data: https: blob: https://res.cloudinary.com https://*.cloudinary.com https://api.londonsimports.com https://*.londonsimports.com ${apiOrigin} https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://upload.wikimedia.org https://*.google.com https://*.google.com.gh https://*.gstatic.com ${isDev ? 'http://127.0.0.1:8000 http://localhost:8000' : ''}`,
  "font-src 'self' https://fonts.gstatic.com data:",
  `connect-src 'self' https://res.cloudinary.com https://api.cloudinary.com https://*.cloudinary.com https://api.londonsimports.com https://*.londonsimports.com ${apiOrigin} ${isDev ? 'http://127.0.0.1:8000 http://localhost:8000' : ''} https://api.paystack.co https://js.paystack.co https://checkout.paystack.com https://paystack.com https://payproxyapi.hubtel.com https://api-txnstatus.hubtel.com https://pay.hubtel.com https://*.hubtel.com https://*.sentry.io https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://www.googletagmanager.com https://stats.g.doubleclick.net https://*.google.com.gh https://*.google.com https://*.gstatic.com https://accounts.google.com https://identitytoolkit.googleapis.com https://oauth2.googleapis.com https://*.googleapis.com https://www.googleapis.com https://vercel.live https://*.wikimedia.org`,
...
const nextConfig: NextConfig = {
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'api.londonsimports.com',
        pathname: '/media/**',
      },
      {
        protocol: 'https',
