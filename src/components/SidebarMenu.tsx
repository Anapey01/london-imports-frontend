...
export default function SidebarMenu({ isOpen, onClose }: SidebarMenuProps) {
    ...
    const [categoriesOpen, setCategoriesOpen] = useState(true); // Default open on desktop sidebar? Maybe closed to save space. Let's start closed or check UX. Mobile was closed. Let's start closed.
        ...
        <div className="fixed inset-0 z-50 flex">
            ...
            >
                ...
                <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100 bg-gray-50/50">
                    ...
                    <button
                        onClick={onClose}
                        className="p-2 -mr-2 text-gray-400 hover:text-pink-600 rounded-full transition-colors focus:outline-none"
                ...
                <div className="flex-1 overflow-y-auto pb-20">
                    ...
                    <div className="mt-4 border-t border-gray-100 pt-4">
                        ...
                        {isAuthenticated ? (
                            ...
                            <>
                                <Link href="/login" onClick={onClose} className="flex items-center gap-4 px-6 py-3 hover:bg-gray-50 text-gray-700 font-medium transition-colors">
                                    <LogIn className="w-5 h-5 text-gray-500" />
                                    <span>Sign In</span>
                                </Link>
                                <Link href="/register" onClick={onClose} className="flex items-center gap-4 px-6 py-3 hover:bg-gray-50 text-gray-700 font-medium transition-colors">
                                    <User className="w-5 h-5 text-gray-500" />
                    ...
                    <div className="mt-8 px-6 pb-12">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://tiktok.com" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-400 hover:bg-black hover:text-white transition-all"><span className="sr-only">TikTok</span><svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" /></svg></a>
                        </div>
                    </div>
                </div>
            </div>
