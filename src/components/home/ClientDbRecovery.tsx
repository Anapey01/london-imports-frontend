        ...
        return (
            <div className="fixed inset-0 z-[9999] bg-[#020617] text-slate-100 flex flex-col justify-between p-6 md:p-12 overflow-y-auto font-sans select-none">
                ...
                <header className="relative z-10 w-full flex items-center justify-between gap-4 border-b border-slate-900 pb-5">
                    ...
                    <div className="flex items-center gap-2 px-2.5 py-0.5 rounded-full text-[9px] font-extrabold tracking-widest bg-emerald-950/80 border border-emerald-500/30 text-emerald-400 uppercase">
