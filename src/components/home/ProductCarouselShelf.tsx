...
export default function ProductCarouselShelf({ title, products = [] }: ProductCarouselShelfProps) {
    ...
    return (
        <section className="py-8 px-4 max-w-7xl mx-auto bg-white dark:bg-slate-900 border border-slate-100/60 dark:border-slate-800/50 rounded-none shadow-[0_1px_4px_rgba(0,0,0,0.015)] my-4 relative overflow-hidden group/shelf">
            {/* Header */}
