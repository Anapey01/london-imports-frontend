...
export default function MobileMenuDrawer({ isOpen, onClose }: MobileMenuDrawerProps) {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div
                className="fixed inset-y-0 left-0 w-[85%] max-w-sm z-50 shadow-2xl overflow-hidden flex flex-col transition-colors duration-300 bg-primary-surface animate-slide-in-left"
                role="dialog"
                aria-modal="true"
            ...
            >
                ...
                <div
                    className="flex items-center justify-between px-4 py-4 border-b border-gray-100 dark:border-slate-800 sticky top-0 z-20 transition-all duration-300 bg-primary-surface/80 backdrop-blur-md"
                >
                    <div className="flex items-center gap-2">
                        {/* THE MINIMALIST MENU ICON */}
                        <div
                            onClick={onClose}
                            className="p-2 -ml-2 cursor-pointer active:scale-90 transition-all text-slate-700"
                        >
                        ...
                        <Link href="/" onClick={onClose} className="flex items-center gap-1.5 group">
                            ...
                            <div className="flex flex-col leading-none">
                                <span className="text-[11px] font-black tracking-tighter text-slate-800 transition-colors">LONDON&apos;S</span>
                                <span className="text-[8px] font-bold text-green-600 tracking-[0.1em] uppercase">Imports</span>
                            </div>
                        </Link>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar pt-2 pb-24 flex flex-col">
                    ...
                    <div className="px-2">
                        {isAuthenticated ? (
                            <Link
                                href="/profile"
                                onClick={onClose}
                                className="flex items-center justify-between px-6 py-4 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 transition-all font-semibold text-[15px] text-slate-700"
                            >
                            ...
                            <div className="flex flex-col">
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <UserPlus className="w-5 h-5 text-slate-600" strokeWidth={1.5} />
                                        SIGN UP
                                    </div>
                                    <ChevronRight className="w-4 h-4 text-slate-300" strokeWidth={1.5} />
                                </Link>
                    ...
                    <div className="px-2">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    AI Sourcing
                                    <span className="text-[9px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full font-bold">New</span>
                                </div>
                            </div>
                            <ChevronRight className="w-4 h-4 text-slate-300" strokeWidth={1.5} />
                        </Link>
                    ...
                    <div className="px-2">
                        <button
                            ...
                            className="w-full flex items-center justify-between px-6 py-4 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 transition-all font-semibold text-[15px] text-slate-700"
                        >
                            <div className="flex items-center gap-4">
                                <LayoutGrid className="w-5 h-5 text-slate-600" strokeWidth={1.5} />
                                PRODUCTS
                            </div>
                            <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${productsOpen ? 'rotate-180' : ''} text-slate-400`} strokeWidth={1.5} />
                        </button>
                    ...
                    <div className="px-2 space-y-1">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <HelpCircle className="w-5 h-5 text-slate-600" strokeWidth={1.5} />
                                HELP CENTER
                            </div>
                            <ChevronRight className="w-4 h-4 text-slate-300" strokeWidth={1.5} />
                        </Link>
                        ...
                        <div>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <ShoppingBag className="w-5 h-5 text-slate-600" strokeWidth={1.5} />
                                    SHOP
                                </div>
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${shopOpen ? 'rotate-180' : ''} text-slate-400`} strokeWidth={1.5} />
                            </button>
                                ...
                                <div className="pl-14 pr-4 py-2 space-y-1">
                                    {SHOP_ITEMS.map((item) => (
                                        <Link
                                            ...
                                            href={item.href}
                                            onClick={onClose}
                                            className="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 text-[14px] font-medium group-hover:text-green-600 transition-all text-slate-600"
                                        >
                                            <item.icon className="w-4.5 h-4.5 text-slate-400" strokeWidth={1.5} />
                                            {item.name}
                                        </Link>
                                    ))}
                                </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${supportOpen ? 'rotate-180' : ''} text-slate-400`} strokeWidth={1.5} />
                            </button>
                    ...
                    {isAuthenticated && (
                        <div className="px-2 mt-4">
                            <button
                                ...
                                className="w-full flex items-center justify-between px-6 py-4 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/10 transition-all font-semibold text-[15px] text-red-600"
                            >
                                <div className="flex items-center gap-4">
                                    <X className="w-5 h-5 opacity-50" strokeWidth={1.5} />
                                    EXIT ACCOUNT
                                </div>
                            </button>
                        </div>
                    ...
                    <div className="mt-auto px-6 pb-20">
                        {/* SOCIAL ICONS */}
                        <div className="flex justify-center items-center gap-8 py-6 border-t border-gray-100 dark:border-slate-800">
                            <a href={siteConfig.socials.instagram} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-pink-600 transition-all hover:scale-110 active:scale-95" aria-label="Follow us on Instagram">
                                <Instagram size={22} strokeWidth={1.5} />
                            </a>
                            <a href={siteConfig.socials.tiktok} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-black dark:hover:text-white transition-all hover:scale-110 active:scale-95" aria-label="Follow us on TikTok">
                                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" /></svg>
                            </a>
                            <a href={siteConfig.socials.snapchat} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-yellow-500 transition-all hover:scale-110 active:scale-95" aria-label="Follow us on Snapchat">
                        ...
                        <div className="flex items-center justify-between px-4 py-6 border-t border-gray-100 dark:border-slate-800">
                            <span className="text-[12px] font-medium text-slate-500">Theme Mode</span>
                            <ThemeToggle />
                        </div>
                    </div>
                </div>
