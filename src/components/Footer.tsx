...
const Footer = () => {
    ...
    return (
        <footer className="hidden md:block bg-surface pt-40 pb-16 border-t border-border-standard relative overflow-hidden selection:bg-emerald-100 font-sans">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-12 mb-24 border-b border-slate-900 dark:border-white pb-16">
                    <div className="max-w-xl">
                        <div className="flex items-center gap-6 mb-12">
                             <div className="relative w-16 h-16 border border-content-primary overflow-hidden bg-surface">
                                 <Image 
                                    src="/logo.jpg" 
                    ...
                    <div className="text-right">
                         <div className="flex items-center justify-end gap-6 mb-8">
                             ...
                             <a href={siteConfig.socials.snapchat} target="_blank" rel="noopener" className="text-content-secondary hover:text-content-primary transition-colors" title="Snapchat" aria-label="Snapchat">
                             ...
                             <a href={siteConfig.socials.facebook} target="_blank" rel="noopener" className="text-slate-400 dark:text-slate-600 hover:text-slate-900 dark:hover:text-white transition-colors" title="Facebook" aria-label="Facebook">
                                <Facebook className="w-5 h-5" strokeWidth={1.5} />
                             </a>
                             <a href="https://www.trustpilot.com/review/londonsimports.com" target="_blank" rel="noopener" className="text-content-secondary hover:text-content-primary transition-colors" title="Trustpilot" aria-label="Trustpilot">
                ...
                <div className="grid md:grid-cols-12 gap-px bg-border-standard border border-border-standard mb-24 font-sans">
                    ...
                    {/* Column 02: Support */}
                    <div className="bg-surface p-12 md:col-span-3 border-l border-border-standard">
                        <span className="text-[9px] font-black uppercase tracking-[0.4em] text-content-secondary mb-8 block">Our Company</span>
                        <ul className="space-y-4">
                            <li><Link href="/about" className="text-sm font-semibold text-content-secondary hover:text-content-primary transition-colors block">About London&apos;s Imports</Link></li>
                            ...
                            <li><Link href="/prohibited-items" className="text-sm font-semibold text-content-secondary hover:text-content-primary transition-colors block">Prohibited Items</Link></li>
                    ...
                    <div className="bg-surface p-12 md:col-span-3 border-l border-border-standard">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="/download" className="text-sm font-bold text-content-primary hover:italic hover:translate-x-1 transition-all inline-block uppercase tracking-widest mt-2">Download Android App</Link></li>
                        </ul>
                    </div>
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-16 pt-16 border-t border-border-standard">
                    <div className="max-w-md">
                        <div className="flex items-center gap-3 mb-8">
                             <MapPin className="w-4 h-4 text-content-primary" strokeWidth={1.5} />
                             <span className="text-[9px] font-black uppercase tracking-widest text-content-primary">Our Location</span>
                        </div>
                        <address className="text-xl md:text-2xl font-black text-content-primary leading-tight not-italic">
                            {siteConfig.address}
                        </address>
                        <div className="flex gap-12 mt-10">
                             <div className="border-l border-content-primary pl-6 group transition-opacity">
                                  <span className="text-[9px] font-black uppercase tracking-widest text-content-secondary block mb-2">Customer Support</span>
                                  <span className="text-sm font-black text-content-primary tracking-tighter">+{siteConfig.whatsapp}</span>
                             </div>
                             <div className="border-l border-content-primary pl-6 group transition-opacity">
                                  <span className="text-[9px] font-black uppercase tracking-widest text-content-secondary block mb-2">Order Help</span>
                                  <span className="text-sm font-black text-content-primary tracking-tighter">+{siteConfig.concierge}</span>
                             </div>
                        </div>
                    </div>
                ...
                <div className="mt-32 pt-16 border-t border-border-standard flex items-center justify-between">
                     <p className="text-[9px] font-black text-content-secondary uppercase tracking-[0.4em] selection:text-white">
                        &copy; {new Date().getFullYear()} London&apos;s Imports / All Rights Reserved.
                     </p>
                     <div className="flex items-center gap-8">
                         <span className="text-[9px] font-black text-content-secondary uppercase tracking-widest italic">Trusted Since 2020</span>
                         <ArrowUpRight className="w-3 h-3 text-content-secondary" />
                     </div>
                </div>
            </div>
        </footer>
