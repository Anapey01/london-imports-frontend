    ...
    return (
        <div className={`space-y-12 animate-in fade-in duration-700`}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-slate-100 dark:border-white/10 pb-10">
                <div>
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] block mb-2 text-slate-500 dark:text-slate-400">Authenticated Session</span>
                ...
                <div className="flex items-center gap-6">
                    <div className="text-right">
                        <span className="text-[8px] font-black uppercase tracking-widest block text-slate-500 dark:text-slate-400">Account Tier</span>
                            ...
                            <div className="grid grid-cols-2 gap-px bg-slate-200 dark:bg-white/20 border border-inherit">
                                <div className="p-6 bg-white dark:bg-slate-900">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-200">Accumulated Value</span>
                                    </div>
                                ...
                                <div className="p-6 bg-white dark:bg-slate-900 border-l border-inherit">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-200">Order Manifest</span>
                                    </div>
                                    <div className="flex items-baseline gap-2">
                                        <span className={`text-xl sm:text-2xl font-serif font-bold tracking-tighter ${isDark ? 'text-white' : 'text-slate-900'}`}>
                                            {orders.length}
                                        </span>
                                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 font-bold">TXNS</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className={`border ${isDark ? 'bg-slate-900/40 border-slate-800' : 'bg-white border-slate-100 shadow-sm'}`}>
                        <div className="p-8 border-b border-inherit flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <h2 className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-700 dark:text-slate-200">Recent Manifests</h2>
                            </div>
                ...
                <div className="lg:col-span-4 space-y-12">
                    <section className={`border ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-100 shadow-sm'}`}>
                        <div className="p-8 border-b border-inherit flex items-center gap-4">
                            ...
                            <h2 className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-700 dark:text-slate-200">System Node Status</h2>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-px bg-slate-200 dark:bg-white/20 border border-inherit">
                                <div className="p-6 bg-white dark:bg-slate-900 flex flex-col gap-3">
                                    ...
                                    <div className="space-y-1">
                                        <span className="text-[8px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-200">Pending Pay</span>
                                ...
                                <div className="p-6 bg-white dark:bg-slate-900 flex flex-col gap-3 border-l border-inherit">
                                    ...
                                    <div className="space-y-1">
                                        <span className="text-[8px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-200">Fulfilled</span>
                        ...
                        <div className="p-6 bg-slate-50 border-t border-inherit dark:bg-white/5 flex items-center gap-3">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-700 dark:text-slate-200">Identity Secure</span>
                        </div>
                    </section>
