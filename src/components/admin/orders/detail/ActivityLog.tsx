...
export function ActivityLog({ order, isDark }: ActivityLogProps) {
    return (
        <section className={`p-4 sm:p-6 md:p-8 border ${isDark ? 'bg-slate-900/40 border-slate-800' : 'bg-white border-slate-100 shadow-sm'}`}>
            ...
            <div className="space-y-6 sm:space-y-10 relative before:absolute before:left-[7px] before:top-2 before:bottom-2 before:w-[1px] before:bg-inherit">
