            ...
            <div className="bg-white rounded-xl p-4 mb-8 flex flex-wrap gap-4 items-center">
                ...
                <div className="flex-1 min-w-[200px]">
                    <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-store-primary focus:border-transparent"
                    />
                </div>
                ...
                <select
                    ...
                    className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-store-primary bg-white"
                >
            ...
            {isLoading && !products.length ? (
                ...
                <div className="text-center py-20 bg-gray-50 rounded-2xl border border-gray-200">
                    <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm">
                        <svg className="w-10 h-10 text-store-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-gray-600 max-w-md mx-auto mb-8 leading-relaxed">
                        ...
                        <span className="font-semibold text-store-primary"> early access </span>
