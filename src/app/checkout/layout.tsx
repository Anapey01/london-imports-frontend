...
export const metadata: Metadata = {
    title: "Secure Checkout | Buy from China to Ghana | London's Imports",
    ...
    openGraph: {
        title: "Order Checkout | London's Imports",
        description: "Secure payment and shipping from China to Ghana.",
        type: 'website',
    }
};
