                        ...
                        <div className="mt-12 px-4 pb-20">
                            <div className="flex items-center gap-4">
                                ...
                                <button
                                    onClick={handleCheckout}
                                    disabled={isLoading}
                                    className="flex-1 h-11 bg-emerald-600 hover:bg-emerald-500 text-white rounded-none font-black uppercase tracking-[0.3em] text-[10px] transition-all flex items-center justify-center gap-4 active:scale-95 institutional-focus"
                                >
                                    Checkout Hub
