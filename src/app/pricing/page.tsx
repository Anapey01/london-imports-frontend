                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
                                All online transactions are securely routed through our integrated payment partner Hubtel, utilizing bank-grade encryption and supporting MTN MoMo, Telecel Cash, AT Money, and Visa/Mastercard payments. London&apos;s Imports does not store your card details.
                            </p>
                        </div>
            ...
            <section className="py-24 bg-slate-900 text-white">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="https://wa.me/233541096372" target="_blank" rel="noopener" className="inline-block px-8 py-3 bg-emerald-500 text-slate-950 uppercase tracking-widest text-[10px] font-black hover:bg-emerald-700 transition-colors">
                            Sourcing Concierge
                        </a>
                    </div>
                </div>
