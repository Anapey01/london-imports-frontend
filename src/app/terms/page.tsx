            ...
            <div className="max-w-4xl mx-auto px-10 py-24">
                <div className="space-y-12 text-slate-900 dark:text-white">
                    ...
                    <section className="space-y-6">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium">We accept Mobile Money and Cards via our secure payment gateway partner Hubtel (online checkout and USSD shortcode *713*7453#). Full payment is required for immediate purchases. Pre-orders may require a deposit.</p>
                    </section>
