...
export const vendorsAPI = {
  ...
  updateProfile: (data: unknown) => api.patchForm('/vendors/profile/', data),
  payouts: () => api.get('/vendors/payouts/'),
  products: () => api.get('/products/vendor/products/'),
  createProduct: (data: unknown) => api.postForm('/products/vendor/products/', data),
  updateProduct: (id: string, data: unknown) => api.patchForm(`/products/vendor/products/${id}/`, data),
