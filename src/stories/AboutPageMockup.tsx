...
/**
 * 🏢 London's Imports - Restored Jumia-Exact Mockup
 * Merging the approved design (Two-Tone cards, 2 Pillars) with new Authority sections.
 * Final Touch: Jumia-style background image for Key Figures.
 */
export const AboutPageMockup = () => {
    const [stats, setStats] = useState({ visits: 0, sellers: 0, orders: 0, regions: 0 });

    useEffect(() => {
        const timer = setTimeout(() => {
            setStats({ visits: 850, sellers: 120, orders: 22, regions: 16 });
        }, 500);
        ...
        <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-orange-100 selection:text-orange-600">
            ...
            <nav className="bg-white border-b border-gray-100 py-4 px-6 flex items-center justify-between sticky top-0 z-50">
                <div className="flex items-center gap-8">
                    <div className="text-2xl font-black tracking-tighter flex items-center gap-1">
                        LONDON&apos;S<span className="w-5 h-5 bg-orange-500 rounded-full flex items-center justify-center text-[10px] text-white">★</span>
                    </div>
                </div>
                <div className="text-[10px] font-black uppercase tracking-widest text-gray-600 hover:text-orange-600 cursor-pointer">
                    Contact Us
                </div>
            </nav>
            ...
            <section className="pt-20 pb-20 max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">Welcome to London&apos;s Imports</h1>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl h-[400px] bg-slate-200 flex items-center justify-center font-black text-white/40 text-4xl uppercase italic">
                        Logistics Tech
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="w-full lg:w-2/3 space-y-6">
                            <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">
                                <Star className="w-3 h-3" /> Leadership
                            </div>
                            <h3 className="text-3xl font-bold text-gray-900 italic">&quot;Our goal is to create a seamless link between global manufacturing and local demand.&quot;</h3>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 text-left group">
            ...
            {/* 5. Key Figures (RESTORED PREVIOUS STYLE + JUMIA BACKGROUND) */}
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-20">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-y-16">
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                            <div className="text-6xl font-black text-orange-600 mb-2 tabular-nums">{stats.regions > 0 ? stats.regions : '..'}</div>
                            <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Regions Covered</div>
                        </motion.div>
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                            <div className="text-6xl font-black text-orange-600 mb-2 tabular-nums">{stats.sellers > 0 ? stats.sellers + "+" : '..'}</div>
                            <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Verified Suppliers</div>
                        </motion.div>
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
                            <div className="text-6xl font-black text-orange-600 mb-2 tabular-nums">{stats.orders > 0 ? stats.orders + "k+" : '..'}</div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {[
                            ...
                            <div key={idx} className="w-72 bg-white shadow-xl rounded-[1.5rem] overflow-hidden group">
            ...
            <section className="py-24 bg-gray-900 text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-black uppercase tracking-widest text-orange-600 mb-4 italic">Regional Presence</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {ghanaRegions.map((region, idx) => (
                            <motion.div key={idx} whileHover={{ scale: 1.05 }} className="flex items-center gap-3 p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-orange-600/20 hover:border-orange-600/50 transition-all cursor-default group">
            ...
            {/* 9. Footer */}
            <footer className="bg-gray-50 border-t border-gray-100 py-16 text-center opacity-50">
                <div className="text-xl font-black tracking-tighter flex items-center justify-center gap-1">
                    LONDON&apos;S<span className="w-4 h-4 bg-gray-300 rounded-full flex items-center justify-center text-[8px] text-white">★</span>
                </div>
            </footer>
        </div>
    );
