...
export default function WhatsAppButton() {
    ...
    return (
        ...
        >
            {/* Pulse ring */}
            <span className="absolute inset-0 w-16 h-16 bg-green-500 rounded-full animate-ping opacity-25"></span>

            {/* Button */}
            <div className="relative w-16 h-16 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition-all hover:scale-110">
