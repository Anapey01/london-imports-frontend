        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                    ...
                    <div className="p-6 grid gap-6">
                        <div className="flex justify-between items-center border-b border-gray-100 pb-4">
                            ...
                            <div className="text-right">
                                <span className="block text-2xl font-bold text-gray-900">1 - 2</span>
                                <span className="text-xs text-gray-500 font-medium">Business Days</span>
                            </div>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="font-semibold text-gray-700">Standard Shipping</span>
                            <div className="text-right">
                                <span className="block text-2xl font-bold text-gray-900">2 - 4</span>
                                <span className="text-xs text-gray-500 font-medium">Business Days</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Separator */}
                    <div className="h-3 bg-gray-50 border-y border-gray-100"></div>
                    ...
                    <div className="p-6 grid gap-6">
                        <div className="flex justify-between items-center border-b border-gray-100 pb-4">
                            <span className="font-semibold text-gray-700">Express Delivery</span>
                            <div className="text-right">
                                <span className="block text-2xl font-bold text-gray-900">3 - 4</span>
                                <span className="text-xs text-gray-500 font-medium">Business Days</span>
                            </div>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="font-semibold text-gray-700">Standard Shipping</span>
                            <div className="text-right">
                                <span className="block text-2xl font-bold text-gray-900">5 - 7</span>
                                <span className="text-xs text-gray-500 font-medium">Business Days</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6 grid gap-6">
                        <div className="flex justify-between items-center border-b border-gray-100 pb-4">
                            <span className="font-semibold text-gray-700">Express Delivery</span>
                            <div className="text-right">
                                <span className="block text-2xl font-bold text-gray-900">5 - 6</span>
                                <span className="text-xs text-gray-500 font-medium">Business Days</span>
                            </div>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="font-semibold text-gray-700">Standard Shipping</span>
                            <div className="text-right">
                                <span className="block text-2xl font-bold text-gray-900">6 - 8</span>
                                <span className="text-xs text-gray-500 font-medium">Business Days</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
                    <h3 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide border-b border-gray-100 pb-4">
                        Delivery Methods
                    </h3>
                    ...
                    <div className="space-y-8">
                        <div>
                            <h4 className="font-bold text-gray-800 flex items-center gap-3 text-lg">
                                <div className="w-8 h-8 rounded-full bg-pink-50 text-pink-500 flex items-center justify-center font-bold">1</div>
                                Door Delivery
                            </h4>
                            <p className="text-sm text-gray-600 mt-2 leading-relaxed ml-11">
                                ...
                                <strong className="text-gray-900 block mt-1">Delivery will be attempted 3 times over 3 business days (7.00 am to 5.30pm) after which the item will be cancelled.</strong>
                            </p>
                        </div>

                        <div>
                            <h4 className="font-bold text-gray-800 flex items-center gap-3 text-lg">
                                <div className="w-8 h-8 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center font-bold">2</div>
                                Pickup Stations
                            </h4>
                            <p className="text-sm text-gray-600 mt-2 leading-relaxed ml-11">
                                ...
                                <strong className="text-gray-900 block mt-1">Ensure you pickup your item within 5 days, otherwise it will be cancelled.</strong>
                            </p>
                        </div>
                    </div>
                </div>
