    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="prose max-w-none text-gray-700 dark:text-slate-300 space-y-4">
                ...
                <h2 className="text-xl font-semibold mt-6 text-gray-900 dark:text-white">3. Returns & Refunds</h2>
                ...
                <h2 className="text-xl font-semibold mt-6 text-gray-900 dark:text-white">4. Contact</h2>
